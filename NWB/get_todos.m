...
path_ninwb =  [path_codebase 'FYD2NWB-BIDS'];
...
addpath( path_fydml ...
    ...
    ,fullfile(path_ninwb, 'ophys') ...
    ,fullfile(path_ninwb, 'ephys') ...
    ,fullfile(path_ninwb, 'YAML') ...
    ,fullfile(path_ninwb, 'NWB') ...
    ,fullfile(path_ninwb, 'NWB\utility_functions') );
